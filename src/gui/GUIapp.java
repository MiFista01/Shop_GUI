...
import gui.components.list_my_sales;
...
public class GUIapp extends JFrame{
    ...
    list_sale list_purchases = new list_sale(w,"aaa",w,300);  /*лист возможных покупок*/
    list_purchase my_purchases = new list_purchase(w,"aaa",w,300);  /*лист покупок пользователя*/
    list_my_sales list_my_sales = new list_my_sales(w,"aaa",w,300);
    ...
    private void PROFILE(){
        ...
        my_purchases = new list_purchase(w-100,"aaa",w,300);  /*лист покупок пользователя*/
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                (!size.getText().getText().equals(""))&&(!count.getText().getText().equals(""))){
                    try{
                        ...
                        purchases.removeAll();
                        my_money = new label(w,30,"Money: "+personFacade.findById(id).getPurse(),1,15);
        ...
        my_money = new label(w,30,"Money: "+personFacade.findById(id).getPurse(),1,15);
        purchases.add(my_money);
        list_purchases = new list_sale(w-100,"aaa",w,300);
        purchases.add(list_purchases);
        ...
        button_buy.getButton().addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(personFacade.findById(id).getPurse()>= value.getShoes().getPrice() && value.getShoes().getCount()>0){
                    ...
                    purchase.setSale(value);
                    purchaseFacade.create(purchase);

                    my_purchases = new list_purchase(w-100,"aaa",w,300);
                    list_purchases = new list_sale(w-100,"aaa",w,300);
        ...
        tabs.add(advert);
        list_my_sales list_my_sales = new list_my_sales(w-100,"aaa",w,300);
        advert.add(list_my_sales);
    }
