...
import gui.renderers.list_person_render;
...
public class list_person extends JPanel{
    private JLabel title;
    private JList<Shoes> list;

    public list_person(int widthList, String text, int widthWindow, int heightPanel) {
    ...
    private void initComponents(int widthList, String text, int widthWindow, int heightPanel) {
        ...
        list.setCellRenderer(new list_person_render());
