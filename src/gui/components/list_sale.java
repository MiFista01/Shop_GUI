...
import gui.renderers.list_sale_render;
...
public class list_sale extends JPanel{
    private JList<Sale> list;

    public list_sale(int widthList, String text, int widthWindow, int heightPanel) {
    ...
    private void initComponents(int widthList, String text, int widthWindow, int heightPanel) {
        ...
        list.setCellRenderer(new list_sale_render());
